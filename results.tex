...
\begin{table}
\centering
\begin{tabular}{|p{1.0cm}|p{2.5cm}|p{2.50cm}|p{1.25cm}|}
\hline
...
\hspace{0.45in}
\includegraphics[scale=0.45]{pictures/res.eps}
...
\hspace{0.65in}
\includegraphics[scale=0.20]{pictures/pieceofcake.eps}
\captionof{figure}{Original geometry for our use case. The thickness is defined by layers. Here the number of layers is set to 8.}
\label{fig:piece}
\vspace{+0.04in}
~\
